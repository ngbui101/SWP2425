...
#define BMA456_SIG_MOTION_EN_OFFSET              UINT8_C(0x37)
#define BMA456_SIG_MOTION_EN_POS                 UINT8_C(1)
#define BMA456_SIG_MOTION_EN_MSK                 UINT8_C(0x02)

/**\name Significant motion threshold macros */
#define BMA456_SIG_MOTION_THRES_POS              UINT8_C(0)
#define BMA456_SIG_MOTION_THRES_MSK              UINT16_C(0x7FFF)

/**\name Significant motion skiptime macros */
#define BMA456_SIG_MOTION_SKIPTIME_MSK           UINT16_C(0x01FF)

/**\name Significant motion prooftime macros */
#define BMA456_SIG_MOTION_PROOFTIME_POS          UINT8_C(0)
#define BMA456_SIG_MOTION_PROOFTIME_MSK          UINT8_C(0x7F)
...
#define BMA456_SIG_MOTION UINT8_C(0x80)
...
#define BMA456_SIG_MOT_INT UINT8_C(0x10)
